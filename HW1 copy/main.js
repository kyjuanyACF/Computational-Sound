document.addEventListener("DOMContentLoaded", function(event) {
    ...
    function playNote(key) {
        ...
        osc1.frequency.value = (2 * keyboardFrequencyMap[key]) + Math.random() * 15;
        osc2.frequency.value = (3 * keyboardFrequencyMap[key]) + Math.random() * 15;
        osc3.frequency.value = (4 * keyboardFrequencyMap[key]) - Math.random() * 15;
        ...
        osc2.start();
        osc3.start();
        activeOscillators[key] = {osc: osc, osc1: osc1, osc2: osc2, osc3: osc3, gain: gain};
